...
sample_stats <- data.table(
  ...
  n_bin_with_one_direct = length(unique(ad[["motifs_full"]][directly == "Direct"]$bin)),
...
sample_stats <- rbind(sample_stats, data.table(
  ...
  n_bin_with_one_direct = length(unique(fecal_complex[["motifs_full"]][directly == "Direct"]$bin)),
...
simple_fecal <- load_complex_sample(
  "/home/bio.aau.dk/lh14io/Projects/nanomotif/binnary/data/PaPr00000216MP_nm_0.1.18/nanomotif/motifs.tsv",
  "/home/bio.aau.dk/lh14io/Projects/nanomotif/binnary/data/PaPr00000216MP_nm_0.1.18/nanomotif/motifs-scored.tsv",
  "/home/bio.aau.dk/lh14io/Projects/nanomotif/binnary/data/PaPr00000216MP_nm_0.1.18/nanomotif/bin-motifs.tsv",
  "/home/bio.aau.dk/lh14io/Projects/nanomotif/binnary/data/PaPr00000216MP_nm_0.1.18/bins.tsv",
  "../data/PaPr00000216MP/NP-PaPr00000216MP_bins_quality.tsv"
)
sample_stats <- rbind(sample_stats, data.table(
  ...
  n_bin_with_one_direct = length(unique(simple_fecal[["motifs_full"]][directly == "Direct"]$bin)),
