...
plot_bin_motif_presence <- function(bin_info) {
  ...
  ggplot(bin_info) + 
    ...
    annotate("text", label = "Minimum coverage in Nanomotif", y = 1e4, x = 5.5, hjust = 0, size = 3, color = "gray70") +
    geom_text(
...
collected_bin_info[
  , sample := factor(sample, levels = c("Simple Fecal", "Complex Fecal", "Anaerobic Digester"))
]
