...
motifs <- fread("/home/bio.aau.dk/lh14io/Projects/nanomotif/binnary/data/PaPr00000216MP_nm_0.1.18/nanomotif/motifs.tsv")[
  , directly := TRUE
]

motifs_scored <- fread("/home/bio.aau.dk/lh14io/Projects/nanomotif/binnary/data/PaPr00000216MP_nm_0.1.18/nanomotif/motifs-scored.tsv")
...
bin <- fread("/home/bio.aau.dk/lh14io/Projects/nanomotif/binnary/data/PaPr00000216MP_nm_0.1.18/bins.tsv", header = FALSE)
...
motif_full <- motif_full[
  ...
  , bin := paste0(bin, ", <sup><sub>n=", n_contigs, "</sub></sup>")
][
  , name := contig
][
  , motif_markdown := paste0(
