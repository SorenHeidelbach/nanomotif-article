...
main_theme <- theme(
    ...
    axis.text.y = element_markdown(size=5, family = "sans"), # Rotate x-axis labels to 90 degrees
    axis.text.x = element_markdown(size = 5, family = "sans"),
    axis.title.x = element_text(size = 5, family = "sans"),
    axis.title.y = element_text(size = 5, family = "sans"),
    axis.ticks = element_line(linewidth = 0.1),
    legend.title = element_text(size = 5, family = "sans"),
    legend.text = element_text(size = 5, family = "sans"),
...
tb <- data.frame(
  ...
  Monocultures = c("10 (10", "31 (31)", "3 (3)", "100% (100%)", "54", "21", "24 (77%)", "-", "-"),
  `Fecal(Simple)` = c("14 (8)", "27 (21)", "1.9 (2.5)", "85% (100%)", "58", "15", "11 (55%)", "11 (0)", "135 (92)"),
  `Fecal(Complex)` = c("190 (97)", "245 (196)", "1.3 (2)", "56% (75%)", "605", "247", "50 (26%)", "179 (20)", "725 (324)"),
    `Anerobic Digestor` = c("423 (230)", "667 (495)", "1.6 (2.2)", "60% (77%)", "1445", "583", "57 (12%)", "745 (119)", "3489 (899)"),
  `HQMAGs` = c("", "", "", "", "", "","","", "") 
)
...
rownames(ttb) <- c("Monocultures", "Fecal Simples", "Fecal Complex", "Anaerobic Digestor", "*in HQ-MAGs")
...
ttable_grob <- gtable_add_grob(ttable_grob,
        grobs = segmentsGrob( # line across the bottom
            ...
            y1 = unit(0,"npc"),
            gp = gpar(lwd = 2.0)),
        t = 5, b = 5, l = 1, r = ncol(ttable_grob))
...
layout6 <- grid.layout(nrow = 2, ncol = 1,
                      widths = unit(c(1.1, 0.9), "null"),
                      heights = unit(c(4, 1), "null"))

```

```{r}
pdf("/home/bio.aau.dk/wy72yf/Projects/nanomotif-article/main_figures/figure_2.pdf", height = 7.08661417, width = 7.08661417, family = "sans")
