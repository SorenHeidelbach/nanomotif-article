...
combined_benchmark[
  , motif_markdown := case_when(
    motif == "GATC" ~ paste0("*E. coli* K12<br>",  motif_markdown, "<br> Palindromic<br>n=", total_motif_count),
    motif == "GRNGAAGY" ~ paste0("*P. thermoglucosidasius*<br>", motif_markdown, "<br>Short Non-Palindromic<br>n=", total_motif_count),
    motif == "GGCANNNNNNTGG" ~ paste0("*M. ruber*<br>", motif_markdown, "<br> Bipartite<br>n=", total_motif_count)
